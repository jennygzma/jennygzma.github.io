    ...
    <section id="about">
      <div className="container mx-auto flex py-10 md:flex-row flex-col items-center">
        <div className="lg:max-w-lg lg:w-2/5 md:w-1/4 h-2/6 justify-center items-center">
          <img
            className="mx-auto rounded w-1/2 object-scale-down"
            alt="jm"
            src="./profile.png"
          />
          <div className="mx-auto flex py-5 space-x-10 justify-center">
        ...
        <div className="lg:flex-grow md:w-1/4 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-left text-left">
          ...
          <p className="mb-8 leading-relaxed font-mono">
            Hi! 👋 I'm a software engineer based in NYC currently looking for open roles. Previously, I worked at <strong className="text-light-green">DoorDash </strong> 
